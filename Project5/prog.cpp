...
int main(int argc, char *argv[])
{
  ...
  cudaMemcpy(dXcs, hXcs, DATASET_SIZE * sizeof(float), cudaMemcpyHostToDevice);
  cudaMemcpy(dYcs, hYcs, DATASET_SIZE * sizeof(float), cudaMemcpyHostToDevice);
  cudaMemcpy(dRs, hRs, DATASET_SIZE * sizeof(float), cudaMemcpyHostToDevice);
  CudaCheckError();
